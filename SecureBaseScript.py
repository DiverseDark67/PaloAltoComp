...
set rulebase security rules ScoreMail action allow from External to Public source any destination 172.32."""+team_num+""".39 profile-setting profiles spyware strict virus default vulnerability strict
...
set rulebase security rules ScoreEcomm action allow from External to Public source any destination 172.32."""+team_num+""".11 profile-setting profiles spyware strict virus default vulnerability strict
...
set rulebase security rules ScoreDNS action allow from External to Internal source any destination 172.32."""+team_num+""".20 profile-setting profiles spyware strict virus default vulnerability strict
...
set rulebase security rules ScoreSplunk action allow from External to Public source any destination 172.32."""+team_num+""".9 profile-setting profiles spyware strict virus default vulnerability strict
...
# set rulebase security rules CentOStoUbuntuDB action allow from any to any source 172.20.240.11 destination 172.32."""+team_num+""".23 profile-setting profiles spyware strict virus default vulnerability strict
# set rulebase security rules CentOStoUbuntuDB from any source 172.32."""+team_num+""".11
...
# set rulebase security rules CentOSin action allow from External to DMZ source any destination 172.32."""+team_num+""".11 profile-setting profiles spyware strict virus default vulnerability strict
...
# set rulebase security rules DEBIANtoUBUNTU to External destination 172.32."""+team_num+""".23
...
# set rulebase security rules UbuntuDNSin action allow from External to DMZ source any destination 172.32."""+team_num+""".23 profile-setting profiles spyware strict virus default vulnerability strict
# set rulebase security rules UbuntuDNSin application dns service application-default
# set rulebase security rules DEBIANin action allow from External to LAN source any destination 172.32."""+team_num+""".39 profile-setting profiles spyware strict virus default vulnerability strict
...
# set rulebase security rules 2008DNSin action allow from External to LAN source any destination 172.32."""+team_num+""".27 profile-setting profiles spyware strict virus default vulnerability strict
